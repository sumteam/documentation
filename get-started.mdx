...
### Explore Our Lab
<Card title="sumtymeLab" icon="text-align-start" color="black" horizontal href="https://www.sumtyme.ai/lab">
  Learn the underlying theory of our Causal Intelligence Layer (CIL)
</Card>

### Common CIL Use Cases
<Card title="Identify Change at Point of Inception" icon="text-align-start" color="black" horizontal href="https://docs.sumtyme.ai/quickstart/finance">
