...
<Card title="Identify Change at Point of Inception" icon="text-align-start" color="black" horizontal href="https://docs.sumtyme.ai/quickstart/finance">
  The CIL identifies a directional shift at its point of inception in the micro-scale and tracks its evolving impact across scales rather than relying on lagging indicators.
</Card>
