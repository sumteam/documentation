...
| **Pre-Detection Drop** | $0.99 (from $403.30) |
| **Time to Detection** | 2 minutes, 48 seconds |
| **Drawdown Saved** | **99.85%** |

Causal Path (Chain_2)

The robustness of the CIL approach is evidenced by Propagation ID: Chain_2. The signal's ability to propagate through every timeframe confirms it was a systemic shift rather than stochastic noise:
